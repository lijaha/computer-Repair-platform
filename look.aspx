<%@ Page Language="C#" AutoEventWireup="true" CodeFile="look.aspx.cs" Inherits="Default2" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<ul id="navigation">
            ...
            <li><span class="active">查看报修信息</span></li>
            <li><a href="find.aspx">查找报修信息</a></li>
            <li><a href="check.aspx">修改删除信息</a></li>
	</ul>
...
<br />
&nbsp;&nbsp;&nbsp;&nbsp;
<asp:GridView ID="GridView1" runat="server" Width="582px">
</asp:GridView>
&nbsp;<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<br />
